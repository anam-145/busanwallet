 ...
 */
@HiltAndroidApp
class BusanWalletApplication : Application() {
    
    companion object {
        private const val TAG = "BusanWalletApplication"
    }
    ...
    override fun onCreate() {
        ...
        /**
         * 기본 상태:
         * - 메인 프로세스: /data/data/com.busan.wallet/app_webview/
         * - :blockchain 프로세스: /data/data/com.busan.wallet/app_webview/ (동일!)
         * - :app 프로세스: /data/data/com.busan.wallet/app_webview/ (동일!)
         *
         * 문제: 3개 프로세스가 같은 폴더를 사용 → 데이터 충돌!
         *
         * WebView.setDataDirectorySuffix("blockchain")
         * // 결과: /data/data/com.busan.wallet/app_webview_blockchain/
         *
         * WebView.setDataDirectorySuffix("webapp")
         * // 결과: /data/data/com.busan.wallet/app_webview_webapp/
         *
         * 이부분을 진행해줘야함
         * */
