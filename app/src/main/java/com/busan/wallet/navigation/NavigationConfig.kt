...
object NavigationConfig {
     ...
     *
     *   결과: Map<K, V>
     *   navigationIconMap[BusanNavRoute.Main] = NavIconInfo(...)
     */
    private val iconMap = mapOf(
        BusanNavRoute.Main to NavIconInfo(
            selectedIcon = Icons.Filled.Home,
            unselectedIcon = Icons.Outlined.Home,
            labelKey = "main"
        ),
        BusanNavRoute.Hub to NavIconInfo(
            selectedIcon = Icons.Filled.Hub,
            unselectedIcon = Icons.Outlined.Hub,
            labelKey = "hub"
        ),
        BusanNavRoute.Browser to NavIconInfo(
            selectedIcon = Icons.Filled.Language,
            unselectedIcon = Icons.Outlined.Language,
            labelKey = "browser"
        ),
        // DID 기능 임시 비활성화
        // BusanNavRoute.Identity to NavIconInfo(
        //     selectedIcon = Icons.Filled.QrCode,
        //     unselectedIcon = Icons.Outlined.QrCode,
        //     labelKey = "identity"
        // ),
        BusanNavRoute.Settings to NavIconInfo(
    ...
    private val bottomNavRoutes = listOf(
        BusanNavRoute.Main,
        BusanNavRoute.Hub,
        BusanNavRoute.Browser,
        // BusanNavRoute.Identity,  // DID 기능 임시 비활성화
        BusanNavRoute.Settings
    )
