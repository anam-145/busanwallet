package com.busan.wallet.feature.miniapp.webapp.data.repository
...
import com.busan.wallet.feature.miniapp.common.bridge.service.MainBridgeService
...
class WebAppServiceRepositoryImpl @Inject constructor(
    ...
    override suspend fun connectToService(appId: String): MiniAppResult<Boolean> {
        return try {
    ...
    override suspend fun getActiveBlockchainId(): String? {
        val service = _serviceConnection.value 
            ?: return null
            
        return try {
            service.getActiveBlockchainId()
    ...
    override suspend fun requestTransaction(request: TransactionRequest): MiniAppResult<String> {
        val service = _serviceConnection.value 
                ...
                service.requestTransaction(
                    ...
                    object : IBlockchainCallback.Stub() {
                        override fun onSuccess(responseJson: String?) {
                            ...
                            continuation.resume(MiniAppResult.Success(responseJson ?: "{}"))
                        }
