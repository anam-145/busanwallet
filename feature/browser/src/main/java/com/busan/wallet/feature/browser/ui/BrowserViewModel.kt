package com.busan.wallet.feature.browser.ui

import android.util.Log
import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.busan.wallet.core.data.datastore.BlockchainDataStore
import com.busan.wallet.feature.miniapp.common.data.common.MiniAppFileManager
import com.busan.wallet.feature.browser.domain.usecase.*
...
class BrowserViewModel @Inject constructor(
    ...
    private val getInstalledMiniAppsUseCase: com.busan.wallet.feature.miniapp.common.domain.usecase.GetInstalledMiniAppsUseCase
) : ViewModel() {
    ...
    private fun selectBookmark(bookmark: com.busan.wallet.feature.browser.domain.model.Bookmark) {
        loadUrl(bookmark.url)
    }
    
    private fun deleteBookmark(bookmark: com.busan.wallet.feature.browser.domain.model.Bookmark) {
        viewModelScope.launch {
    ...
    private fun loadBlockchainBridge(blockchainId: String) {
        viewModelScope.launch {
            try {
                ...
                when (miniAppsResult) {
                    is com.busan.wallet.core.common.result.MiniAppResult.Success -> {
                        ...
                        miniApp?.bridge?.let { bridgeConfig ->
                            ...
                            when (scriptResult) {
                                ...
                                is com.busan.wallet.core.common.result.MiniAppResult.Error -> {
