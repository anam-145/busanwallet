package com.busan.wallet.feature.auth.ui.setup

import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.busan.wallet.core.security.domain.usecase.SaveAppPasswordUseCase
import com.busan.wallet.feature.auth.domain.PasswordManager
import com.busan.wallet.feature.auth.domain.model.AuthError
// import com.busan.wallet.feature.identity.domain.usecase.InitializeUserDIDUseCase  // DID 기능 비활성화
...
// import kotlinx.coroutines.async  // DID 병렬 처리에만 사용되었으므로 주석 처리
...
class SetupPasswordViewModel @Inject constructor(
    ...
    // private val initializeUserDIDUseCase: InitializeUserDIDUseCase  // DID 기능 비활성화
) : ViewModel() {
    ...
    private fun setupPassword() {
        ...
        viewModelScope.launch {
            ...
            // 비밀번호 저장만 수행 (DID 생성 비활성화)
            val passwordResult = saveAppPasswordUseCase(password)
            
            when {
                passwordResult.isSuccess -> {
                    // 비밀번호 설정 성공
                    android.util.Log.d("SetupPassword", "Password created successfully!")
